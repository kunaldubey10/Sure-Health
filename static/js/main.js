// Sure Health - Main JavaScript File
...
// Console greeting
console.log('%c Welcome to Sure Health! ', 'background: linear-gradient(135deg, #4A90E2 0%, #26A69A 100%); color: white; font-size: 20px; padding: 10px;');
